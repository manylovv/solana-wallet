        ...
        <div className="flex flex-col gap-8 items-center lg:flex-row lg:justify-between">
          <div className="flex flex-col gap-12 sm:items-center text-center">
            <div className="grid gap-8">
              <h1 className="font-medium text-balance text-display-sm md:font-bold md:text-display-md lg:text-display-xl">
                Powerful for developers. Fast for everyone.
              </h1>
              <p className="text-gray-300 text-lg md:text-xl text-balance w-full lg:w-3/4 lg:mx-auto block">
            ...
            <div className="w-full flex gap-2 flex-col sm:flex-row md:w-fit sm:justify-center">
              <button className="justify-center text-white inline-flex items-center gap-3.5 tracking-wider font-mono text-center uppercase rounded-full transition-color font-light whitespace-nowrap bg-button-gradient hover:bg-none hover:bg-white hover:text-black text-md py-4 px-[18px] w-full sm:w-fit">
                <span className="mt-0.5 leading-none">Start Minting</span>
              </button>
              <a
                className="justify-center inline-flex items-center gap-3.5 tracking-wider font-mono text-center uppercase rounded-full transition-color whitespace-nowrap text-white hover:bg-white hover:text-black disabled:bg-gray-500 disabled:text-gray-700 disabled:pointer-events-none disabled:border-common-transparent disabled:bg-none border border-common-white text-md py-4 px-[18px] w-full sm:w-fit"
                href=""
              >
